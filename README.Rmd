...
Generally, additional `label` details to the `aes()` in ggplot, or using `ggplotly()` parameters, provides more careful details of what to show on the pop-up text. Using sound to speak the label might make it even more accessible, like the [Vowel explorer](https://petergill.shinyapps.io/shinyplay/).
